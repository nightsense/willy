...
<ul>
  <li>disable highlighting of current line number: <code class="highlighter-rouge">let g:wonka_dark_CursorLineNr = 'off'</code>, <code class="highlighter-rouge">let g:wonka_light_CursorLineNr = 'off'</code></li>
</ul>
