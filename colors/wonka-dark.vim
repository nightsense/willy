...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#ab988e'
  let g:terminal_color_8 =  '#756861'
  let g:terminal_color_9 =  '#b56f45'
  let g:terminal_color_10 = '#402f25'
  let g:terminal_color_11 = '#614d41'
  let g:terminal_color_12 = '#94847b'
  let g:terminal_color_13 = '#e0cfc5'
  let g:terminal_color_14 = '#ab6a7a'
  let g:terminal_color_15 = '#fff2eb'
endif
...
if filereadable(expand('~/.nightshell/wonka-dark'))
  if !has('gui_running')
...
if exists('g:wonka_dark_CursorLineNr')
if g:wonka_dark_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:wonka_dark_LineNr')
if g:wonka_dark_LineNr == 'off'
