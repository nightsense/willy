" wonka-light, a vim colourscheme by nightsense
"
...
if has('nvim')
  ...
  let g:terminal_color_7 =  '#6b5548'
  let g:terminal_color_8 =  '#94847b'
  let g:terminal_color_9 =  '#e07538'
  let g:terminal_color_10 = '#e0cfc5'
  let g:terminal_color_11 = '#9e8d83'
  let g:terminal_color_12 = '#756861'
  let g:terminal_color_13 = '#402f25'
  let g:terminal_color_14 = '#d46a85'
  let g:terminal_color_15 = '#2b1b12'
endif
...
if filereadable(expand('~/.nightshell/wonka-light'))
  if !has('gui_running')
...
if exists('g:wonka_light_CursorLineNr')
if g:wonka_light_CursorLineNr == 'off'
cal <sid>h('CursorLineNr'     , s:g4 , s:g1 , s:t4 , s:t1 , 'none'      , ''  )
endif
endif

" disable LineNr background altogether
if exists('g:wonka_light_LineNr')
if g:wonka_light_LineNr == 'off'
